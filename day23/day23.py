...
class Burrow():
    def __init__(self, a1: 'Amphipod', a2: 'Amphipod', b1: 'Amphipod', b2: 'Amphipod',
                 c1: 'Amphipod', c2: 'Amphipod', d1: 'Amphipod', d2: 'Amphipod', total_costs=0):
        self.a1 = a1
        self.a2 = a2
        self.b1 = b1
        self.b2 = b2
        ...
        self.not_in_place = self.get_amphis_not_in_place()
    ...
    def __eq__(self, other: 'Burrow'):
        ...
        return (self.a1.position == other.a1.position and self.a2.position == other.a2.position and
                ...
                self.d1.position == other.d1.position and self.d2.position == other.d2.position
                )
...
###A#C#B#D###
  ...
  #########'''
    # Test regular
    # a1 = Amphipod('A', 'a1', (3, 3))
    # a2 = Amphipod('A', 'a2', (2, 3))
    # b1 = Amphipod('B', 'b1', (3, 9))
    # b2 = Amphipod('B', 'b2', (2, 7))
    # c1 = Amphipod('C', 'c1', (2, 5))
    # c2 = Amphipod('C', 'c2', (3, 7))
    # d1 = Amphipod('D', 'd1', (2, 9))
    # d2 = Amphipod('D', 'd2', (3, 5))

    # Test
    a1 = Amphipod('A', 'a1', (3, 3))
    a2 = Amphipod('A', 'a2', (3, 9))
    ...
    start = Burrow(a1, a2, b1, b2, c1, c2, d1, d2, 0)
    ...
    shortest_paths = {start: (start.not_in_place,0, None)}
    visited: Set['Burrow'] = set()
    burrows_to_visit: List[Tuple[int, int,'Burrow']] = []
    heapq.heappush(burrows_to_visit, (0, start.__hash__(), start))
    printcounter = 0
    current_min_final_cost = 50000
    # Dijkstra's algorithm
    while burrows_to_visit:
        score_current, _ , burrow_current = heapq.heappop(burrows_to_visit)
        ...
        for burrow_next in possible_next_burrows:
            ...
            #to avoid searching further if minimum is already found
            if burrow_next not in shortest_paths or cost_next < shortest_paths[burrow_next][0]:
                shortest_paths[burrow_next] = (cost_next, burrow_current)
                if burrow_next not in visited:
                    heapq.heappush(burrows_to_visit, (cost_next, burrow_next.__hash__(), burrow_next))
